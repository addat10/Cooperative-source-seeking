...
classdef Quadratic_InteractionField
    ...
    %Like springs attached between different agents
   properties(Constant)
...
%               unit_vec=(1/vecnorm(dist_euclidean,2,1))*dist_euclidean;
              force=(dist-obj.da)*grad;
              % try polynomial field
              force=1e-2*(vecnorm(dist_euclidean,2,1)^2-obj.da^2)*dist_euclidean;
